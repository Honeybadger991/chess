...
export const initialBoard = new Board([
    new Piece (new Position(0, 0), PieceType.ROOK, TeamType.ALLY, false),
    new Piece (new Position(7, 0), PieceType.ROOK, TeamType.ALLY, false),
    new Piece (new Position(1, 0), PieceType.KNIGHT, TeamType.ALLY, false),
    new Piece (new Position(6, 0), PieceType.KNIGHT, TeamType.ALLY, false),
    new Piece (new Position(2, 0), PieceType.BISHOP, TeamType.ALLY, false),
    new Piece (new Position(5, 0), PieceType.BISHOP, TeamType.ALLY, false),
    new Piece (new Position(3, 0), PieceType.QUEEN, TeamType.ALLY, false),
    new Piece (new Position(4, 0), PieceType.KING, TeamType.ALLY, false),
    new Pawn (new Position(0, 1), TeamType.ALLY, false),
    new Pawn (new Position(1, 1), TeamType.ALLY, false),
    new Pawn (new Position(2, 1), TeamType.ALLY, false),
    new Pawn (new Position(3, 1), TeamType.ALLY, false),
    new Pawn (new Position(4, 1), TeamType.ALLY, false),
    new Pawn (new Position(5, 1), TeamType.ALLY, false),
    new Pawn (new Position(6, 1), TeamType.ALLY, false),
    new Pawn (new Position(7, 1), TeamType.ALLY, false),
